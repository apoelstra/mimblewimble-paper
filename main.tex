...
\begin{abstract} 
\textbf{This is still incomplete, and the author list is not finalized.
If you have encountered this paper floating
...
transaction. Jedusor left open a problem of how to reduce this data;
we solve this, and combine it with existing research for compressing
proof-of-work blockchains, to reduce this 15Gb to less than a megabyte.
\end{abstract}
